...
CSS selector: ``div#fws_690c8c94e198a div.wpb_content_element``
Data:
* Call letters
* URL
* City
...
* Latitude
Notes: 
* Match "Call letters” to combine the 2 data sources. Some manual conformation needed (e.g., "KCUW-LP" in map, "KCUW" on page).
